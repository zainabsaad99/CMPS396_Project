...
if __name__ == "__main__":
    ...
    model = Transformer(len(vocab), len(vocab),
                        ...
                        512,
                        max_length,
                        0.18611158083017465).to(device)

    optimizer = optim.Adam(model.parameters(), lr=	0.0004235449765924043)
    criterion = nn.CrossEntropyLoss(ignore_index=vocab.pad_token)

    # Train
    train_model(model, train_loader, val_loader, optimizer, criterion, device, vocab, epochs=50)
